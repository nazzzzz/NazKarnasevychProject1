...
function setup() {
    ...
    for (i = 0; i < 3; i++) {
        cloudOneArray[i] = new CloudOne(random(0, 2000), random(500, 700));
    }


    for (i = 0; i < 6; i++) {
        cloudTwoArray[i] = new CloudTwo(random(0, 2000), random(700, 850));
    }
}
...
function drawBackground() {
    ...
    //sky Lower
    gradientColor(0, 500, 2000, 390, sky_upper, sky_lower);


    //line of white ish
    gradientColor(0, 890, 2000, 10, color(251, 219, 194), color(249, 236, 227));


    //water
    gradientColor(0, 900, 2000, 100, water_upper, water_lower);


    //grass
	gradientColor(0, 1050, 2000, 175, grass_upper, grass_lower);

    noStroke();
    fill(grass_lower)
    rect(0, 1225, 2000, 175);
