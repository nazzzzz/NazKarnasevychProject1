//class for second type of cloud
function CloudTwo(cloudX, cloudY) {
    ...
    this.display = function() {
        ...
        ellipse(this.xPos - 25, this.yPos - 15, 30, 20);
        ...
        ellipse(this.xPos - 40, this.yPos + 10, 50, 40);
        ...
        fill(this.cloud_dark);
        ellipse(this.xPos, this.yPos + 30, 150, 20);
